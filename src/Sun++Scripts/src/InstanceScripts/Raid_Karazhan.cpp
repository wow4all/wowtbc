...
/////////////////////////////////////////////////////////////////////////////////////////////
//SPECTRAL STALION
#define SPECTRAL_STALION				            15546
#define SPECTRAL_HOOF_STRIKE	                    29577
#define SPECTRAL_ABSORB_VITALITY	                29323
...
class SPECTRAL_STALIONAI : public MoonScriptCreatureAI
{
	...
	SPECTRAL_STALIONAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
	{
        ...
        //spells
		AddSpell(SPECTRAL_HOOF_STRIKE, Target_Current, 100, 0, 15, 0, 5);
		AddSpell(SPECTRAL_ABSORB_VITALITY, Target_Current, 100, 0, 15, 0, 10);
	}
};
/////////////////////////////////////////////////////////////////////////////////
...
class SPECTRAL_CHARGERAI : public MoonScriptCreatureAI
{
	...
	SPECTRAL_CHARGERAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
	{
        ...
        //spells
		AddSpell(SPECTRAL_CHARGE, Target_RandomPlayer, 100, 0, 15, 0, 10);
...
void SetupKarazhan(ScriptMgr* pScriptMgr)
{
	...
	//Bfx Moroes related Fight Still few more to script for this encounter
