...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//EVENT - Sun Well
#define CN_ANVEENA					26046
#define CN_KIL_JADEN_DUMMY			25608
#define CN_KILJADEN					25315
#define CN_VOLATILE_FELFIRE_FIEND	25598
#define CN_HAND_OF_THE_DECEIVER		25955
#define CN_FELFIRE_PORTAL			25603

#define ANVEENAS_PRISON				46367
#define SHADOW_CHANNELING			46757
...
class KJDummyAI : public MoonScriptBossAI
{
	...
	{
		RemoveAura( 46410 );
		SpawnCreature( CN_KILJADEN, false );
	};
...
{
	pScriptMgr->register_creature_script( CN_ANVEENA, &AnveenaAI::Create );
	pScriptMgr->register_creature_script( CN_KIL_JADEN_DUMMY, &KJDummyAI::Create );
	pScriptMgr->register_creature_script( CN_KILJADEN, &KilJaedenAI::Create );
	pScriptMgr->register_creature_script( CN_HAND_OF_THE_DECEIVER, &HandOfTheDeceiverAI::Create );
	pScriptMgr->register_creature_script( CN_VOLATILE_FELFIRE_FIEND, &FellFireFiendAI::Create );
	pScriptMgr->register_creature_script( CN_FELFIRE_PORTAL, &FellfirePortalAI::Create );
