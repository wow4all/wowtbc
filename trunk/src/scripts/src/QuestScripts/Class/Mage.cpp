...
const uint8 MAX_AURAS = 56;				// 40 buff slots + 16 debuff slots.
const uint8 MAX_POSITIVE_AURAS = 40;	// 40 buff slots
const uint16 MAX_PASSIVE_AURAS = 281;		// passive aury = talenty + dalsi
