...
public:
	...
	void AIUpdate()
	{
		...
		if( Status == 100 && m_bannerStatus != BANNER_STATUS_ALLIANCE )
		{
			...
			// state update
			_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_neutralStateFields[towerid], 0);
			_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_allianceStateFields[towerid], 1);
		...
		else if( Status == 0 && m_bannerStatus != BANNER_STATUS_HORDE )
		{
			...
			// state update
			_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_neutralStateFields[towerid], 0);
			_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_hordeStateFields[towerid], 1);
		...
		else if( m_bannerStatus != BANNER_STATUS_NEUTRAL )
		{
			...
			if( m_bannerStatus == BANNER_STATUS_ALLIANCE && Status <= 50 )
			{
				...
				// state update
				_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_allianceStateFields[towerid], 0);
				_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_neutralStateFields[towerid], 1);
			...
			else if( m_bannerStatus == BANNER_STATUS_HORDE && Status >= 50 )
			{
				...
				// state update
				_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_hordeStateFields[towerid], 0);
				_gameobject->GetMapMgr()->GetWorldStateManager()->SetWorldState(g_neutralStateFields[towerid], 1);
